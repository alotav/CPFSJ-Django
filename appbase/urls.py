...
urlpatterns = [
    ...
    path('reset/<uidb64>/<token>', auth_views.PasswordResetConfirmView.as_view(template_name="autenticacion/reinicio_confirmacion.html"), name="password_reset_confirm"),
